    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lanzar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getContext().startService(new Intent(getActivity().getBaseContext(),ServicioMusica.class));
            }
        });
        ...
        detener.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getContext().stopService(new Intent(getActivity().getBaseContext(),ServicioMusica.class));
            }
        });
